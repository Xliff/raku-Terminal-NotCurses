...
sub nccell_duplicate (ncplane $n, nccell $targ, nccell $c)
  returns int32
  is      native(&notcurses)
  is      export
{ * }

sub nccell_extended_gcluster (ncplane $n, nccell $c)
  returns Str
  is      native(&notcurses)
  is      export
...
sub nccell_load (ncplane $n, nccell $c, Str $gcluster)
  returns int32
  is      native(&notcurses)
  is      export
{ * }

sub nccell_load_char (ncplane $n, nccell $c, Str $ch)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_load_egc32 (ncplane $n, nccell $c, uint32 $egc)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_load_ucs32 (ncplane $n, nccell $c, uint32 $u)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_off_styles (nccell $c, uint32 $s)
  is      native(notcurses-export)
  is      export
  is      symbol('nccell_off_styles_export')
{ * }

sub nccell_on_styles (nccell $c, uint32 $s)
  is      native(notcurses-export)
  is      export
...
sub nccell_release (ncplane $n, nccell $c)
  is      native(&notcurses)
  is      export
{ * }

sub nccell_set_bchannel (nccell $c, uint32 $channel)
  returns uint64
  is      native(notcurses-export)
  is      export
...
sub nccell_set_bg_alpha (nccell $c, uint32 $a)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_set_bg_palindex (nccell $cl, uint32 $i)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_set_bg_rgb (nccell $c,uint32 $r)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_set_channels (nccell $c, uint64 $channels)
  returns uint64
  is      native(notcurses-export)
  is      export
...
sub nccell_set_fchannel (nccell $c, uint32 $channel)
  returns uint64
  is      native(notcurses-export)
  is      export
...
sub nccell_set_fg_alpha (nccell $c, uint32 $a)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_set_fg_palindex (nccell $cl, uint32 $i)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_set_fg_rgb (nccell $c, uint32 $channel)
  returns int32
  is      native(notcurses-export)
  is      export
...
sub nccell_set_styles (nccell $c, uint32 $s)
  is      native(notcurses-export)
  is      export
  is      symbol('nccell_set_styles_export')
{ * }

sub nccell_strdup (ncplane $n, nccell $c)
  returns Str
  is      native(notcurses-export)
  is      export
...
sub nccellcmp (ncplane $n1, nccell $c1, ncplane $n2, nccell $c2)
  returns bool
  is      native(notcurses-export)
  is      export
